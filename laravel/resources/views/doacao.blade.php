    ...
    <div class="section-title"><h2>Preencha as informações <br>abaixo  para realizar sua doação</h2></div>
      <div class="row mt-1 d-flex justify-content-end" data-aos="fade-right" data-aos-delay="100">
        <div class="col-lg-6 mt-5 mt-lg-0" data-aos="fade-left" data-aos-delay="100">
          <form action="{{route('Formulario.store')}}" method="post" role="form" class="php-email-form">
            @csrf
          <div class="form-row">
              <div class="col-md-6 form-group">
                <input type="text" class="form-control" name="nome" id="nome_livro" placeholder="nome do livro" data-rule="minlen:4" data-msg="Insira o nome do livro que deseja requisitar" />
              </div>
              <div class="col-md-6 form-group"> 
            ...
            <div class="row mt-3">
              ...
              <a href="{{route('clientes.create')}}" >Fazer Cadastro</a>
              </div>
